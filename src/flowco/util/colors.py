...
def _rgb_to_hex(rgb_string):
    ...
    # Convert each value to an integer and then to a hexadecimal string
    r, g, b = [int(value) for value in rgb_values]
    # Format as hexadecimal and return
    return f"#{r:02x}{g:02x}{b:02x}"


def get_colorbrewer_palette(name, n):
    """
    take palette name and number of colors and return colors in hex notation
    """
    palette = _colorbrewer[name]
    return [_rgb_to_hex(x) for x in palette[str(n)]]
...
if __name__ == "__main__":
    ...
    def lighten_color(hex_color, percentage):
        ...
        # Lighten the color
        lightened_rgb = tuple(
            int((1 - percentage) * component + percentage * 255)
